...
public class BackupFrame extends javax.swing.JFrame {
    ...
    public BackupFrame() {
        initComponents();
        getContentPane().setBackground(new java.awt.Color(34, 139, 34));
    ...
    private void backup() {
        ...
        try {
            ...
            Date date = new Date();
            String filepath = "C:\\Users\\Mario\\Documents\\MEGA\\Mario2\\bkp.sql";
            String batchCommand = "";
//only backup the data not included create database
            batchCommand = "c:\\ventas\\mysqldump.exe" + " -h " + "localhost" + " --port " + "3306" + " -u " + "root" + " --password=root mario" + " -r " + filepath;
            Runtime runtime = Runtime.getRuntime();
            p = runtime.exec(batchCommand);
            int processComplete = p.waitFor();
            if (processComplete == 0) {
                status = true;
                JOptionPane.showMessageDialog(this,"Backup creado correctamente DB " + "wpal" + " en " + "MEGA" + ":" + 3306);
            } else {
                status = false;
                JOptionPane.showMessageDialog(this,"Error creando Backup DB " + "wpal" + " in " + "MEGA" + ":" + 3306);
            }
