 ...
 * @author Mario
 */
public class AbmRenglonAbonoFrame extends javax.swing.JFrame {

    private List<Abono> abonos = null;
    /**
     * Creates new form AbmTextoFrame
     */
    public AbmRenglonAbonoFrame() {
        initComponents();
        llenarTabla();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AbmRenglonAbonoFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AbmRenglonAbonoFrame().setVisible(true);
            }
        });
    }
    ...
    private void llenarTabla() {
        ...
        try {
            ...
            Logger.getLogger(AbmRenglonAbonoFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void nuevo() {
        ...
        NuevoRenglonAbonoFrame nraf = new NuevoRenglonAbonoFrame(abono);
        nraf.setVisible(true);
        this.dispose();
    }
...
//        System.out.println(abonos);
        Abono abono = abonos.get(row);
        ModificarRenglonAbonoFrame nraf = new ModificarRenglonAbonoFrame(abono);
        nraf.setVisible(true);
        this.dispose();
    }
    ...
    private void habilitarPeriodo() {
        ...
        try {
            clientes = new ClienteService().getClientesByAbono(abono);
        } catch (Exception ex) {
            Logger.getLogger(AbmRenglonAbonoFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//        System.exit(0);
        if(clientes != null && !clientes.isEmpty()){
            int a = JOptionPane.showConfirmDialog(this
                    , "Confirme activar abonos", "Atención"
